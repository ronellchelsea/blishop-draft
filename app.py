...
@app.route('/rashguard/b1')
def b1():
    return render_template('sportsbra/b1.html')

@app.route('/sportsbra/b2')
def b2():
    return render_template('sportsbra/b2.html')

@app.route('/sportsbra/b3')
def b3():
    return render_template('sportsbra/b3.html')

@app.route('/sportsbra/b4')
def b4():
    return render_template('sportsbra/b4.html')

@app.route('/sportsbra/b5')
def b5():
    return render_template('sportsbra/b5.html')
